...
const TOP_5_HEALTHCARE_CLONES = [
  {
    id: 'health-clone-1',
    title: 'Epic Hospital System Clone',
    subtitle: 'Enterprise hospital management system used by large healthcare organizations.',
    category: 'Healthcare',
    description: 'Enterprise hospital management system used by large healthcare organizations.',
    ...
    github_repo: 'https://github.com/saasvala/epic-hospital-clone-software',
    price: 5, old_price: 10, rating: 4.9,
    isAvailable: true, status: 'active', slug: 'epic-hospital-clone-software',
  },
  {
    id: 'health-clone-2',
