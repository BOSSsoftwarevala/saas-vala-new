...
interface EduProduct {
  ...
  image: string;
  subCategory: string;
  badge: 'CERTIFIED' | 'AI-ENHANCED' | 'GOVT APPROVED' | 'NEW LAUNCH' | 'BESTSELLER';
  rating: number;
  institutions: number;
  features: string[];
  techStack: string[];
...
const eduProducts: EduProduct[] = [
  { id: 'ed-1', title: 'SCHOOL ERP COMPLETE', subtitle: 'K-12 all-in-one management system', image: 'https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=400&h=300&fit=crop', subCategory: 'School Management', badge: 'BESTSELLER', rating: 4.9, institutions: 1240, features: ['Timetable', 'Attendance', 'Fee Mgmt', 'Parent App', 'Report Cards'], techStack: ['React', 'Node.js', 'PostgreSQL'], price: 5, icon: GraduationCap },
  { id: 'ed-2', title: 'ONLINE LMS PRO', subtitle: 'Complete learning management system', image: 'https://images.unsplash.com/photo-1509062522246-3755977927d7?w=400&h=300&fit=crop', subCategory: 'E-Learning', badge: 'AI-ENHANCED', rating: 4.8, institutions: 890, features: ['Live Classes', 'AI Quizzes', 'Certificates', 'Progress Track', 'Assignments'], techStack: ['Next.js', 'Python', 'MongoDB'], price: 5, icon: BookOpen },
  { id: 'ed-3', title: 'COLLEGE ERP SUITE', subtitle: 'Higher education institution ERP', image: 'https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=400&h=300&fit=crop', subCategory: 'College Management', badge: 'GOVT APPROVED', rating: 4.7, institutions: 320, features: ['Admission Portal', 'Exam Module', 'Library', 'Hostel Mgmt', 'Alumni'], techStack: ['Angular', 'Java', 'Oracle'], price: 5, icon: Award },
  { id: 'ed-4', title: 'COACHING CENTRE ERP', subtitle: 'Tuition & coaching management platform', image: 'https://images.unsplash.com/photo-1427504494785-3a9ca7044f45?w=400&h=300&fit=crop', subCategory: 'Coaching', badge: 'CERTIFIED', rating: 4.8, institutions: 2100, features: ['Batch Mgmt', 'Test Series', 'Results', 'Fee Collection', 'SMS Alerts'], techStack: ['React', 'Express', 'MySQL'], price: 5, icon: Users },
  { id: 'ed-5', title: 'SKILL DEVELOPMENT APP', subtitle: 'Vocational training & certification system', image: 'https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=400&h=300&fit=crop', subCategory: 'Skill Training', badge: 'GOVT APPROVED', rating: 4.6, institutions: 560, features: ['Trade Courses', 'Assessments', 'Job Board', 'NSDC Sync', 'E-Certificates'], techStack: ['React', 'Node.js', 'AWS'], price: 5, icon: Zap },
  { id: 'ed-6', title: 'UNIVERSITY ADMISSION', subtitle: 'End-to-end admission management portal', image: 'https://images.unsplash.com/photo-1541339907198-e08756dedf3f?w=400&h=300&fit=crop', subCategory: 'University', badge: 'NEW LAUNCH', rating: 4.5, institutions: 180, features: ['Online Apply', 'Merit Lists', 'Document Upload', 'Fee Payment', 'Allotment'], techStack: ['Vue.js', 'Laravel', 'PostgreSQL'], price: 5, icon: GraduationCap },
  { id: 'ed-7', title: 'LIBRARY MANAGEMENT', subtitle: 'Smart library with RFID & e-resources', image: 'https://images.unsplash.com/photo-1481627834876-b7833e8f5570?w=400&h=300&fit=crop', subCategory: 'Library', badge: 'CERTIFIED', rating: 4.7, institutions: 1680, features: ['Book Catalog', 'RFID Issue', 'E-Books', 'Fine Calc', 'Member Portal'], techStack: ['React', 'Node.js', 'MySQL'], price: 5, icon: BookOpen },
  { id: 'ed-8', title: 'EXAM & TEST ENGINE', subtitle: 'Online examination & assessment platform', image: 'https://images.unsplash.com/photo-1606326608690-4e0281b1e588?w=400&h=300&fit=crop', subCategory: 'Examination', badge: 'AI-ENHANCED', rating: 4.8, institutions: 740, features: ['Question Bank', 'AI Proctoring', 'Auto Grade', 'Rank Lists', 'Reports'], techStack: ['React', 'Python', 'Redis'], price: 5, icon: Award },
];
    ...
    <section className="py-4">
      ...
      <div className="mx-4 md:mx-8 mb-5 rounded-xl bg-gradient-to-r from-blue-950/80 via-indigo-950/60 to-card border border-blue-500/20 p-4 flex items-center gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-muted-foreground">Empowering 10,000+ institutions across India. From K-12 to university. From coaching to vocational.</p>
        </div>
      ...
      <div className="flex gap-2 overflow-x-auto scrollbar-hide px-4 md:px-8 mb-4 pb-1" style={{ scrollbarWidth: 'none' }}>
        {['All', 'School', 'College', 'Coaching', 'E-Learning', 'Skill Training', 'University', 'Library', 'Examination'].map((cat) => (
          <Badge
            key={cat}
      ...
      <SectionSlider>
        {eduProducts.map((product, index) => {
          ...
          return (
            ...
            >
              <div className="relative rounded-xl overflow-hidden bg-card border border-blue-500/20 shadow-lg shadow-blue-500/5 h-full flex flex-col">
                {/* Image */}
                ...
                <div className="p-4 flex flex-col flex-1">
                  ...
                  <div className="flex flex-wrap gap-1 mb-3">
                    {product.techStack.map((t, i) => (
                      <Badge key={i} variant="secondary" className="text-[8px] bg-blue-500/10 text-blue-400 border-0 px-1.5 py-0">{t}</Badge>
                    ))}
                  </div>
                  ...
                  <div className="mt-auto">
                    ...
                    <div className="flex gap-2">
                      <Button size="sm" variant="outline" className="flex-1 h-8 text-[10px] gap-1 border-blue-400/30 text-blue-400 hover:bg-blue-500/10">
                        <Zap className="h-3.5 w-3.5" /> DEMO
                      </Button>
                      <Button size="sm" className="flex-1 h-8 text-[10px] gap-1 bg-blue-600 hover:bg-blue-500 text-white border-0" onClick={() => onBuyNow(product)}>
