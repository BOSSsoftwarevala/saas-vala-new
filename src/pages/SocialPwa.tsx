...
const VALID_KEYS = ['SOCIAL-APK-2026-001', 'SOCIAL-APK-2026-002', 'SOCIAL-APK-2026-003', 'SOCIAL-PWA-2026-001', 'COMMUNITY-APK-2026-001'];
...
export default function SocialPwa() {
  ...
  const activate = () => {
    if (VALID_KEYS.includes(keyInput.trim().toUpperCase())) {
      ...
      toast.success(`🎉 License activated! Valid for ${LICENSE_DAYS} days. All 5 Social Media software demos unlocked.`);
