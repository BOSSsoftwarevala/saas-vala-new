...
const VALID_KEYS = ['AI-APK-2026-001', 'AI-APK-2026-002', 'AI-APK-2026-003', 'AI-PWA-2026-001', 'AUTOMATION-APK-2026-001'];
const PFX = 'ai-pwa';
...
export default function AiToolsPwa() {
  ...
  const activate = () => {
    if (VALID_KEYS.includes(keyInput.trim().toUpperCase())) {
      ...
      toast.success(`🎉 License activated! Valid for ${LICENSE_DAYS} days. All 5 AI & Automation software demos unlocked.`);
