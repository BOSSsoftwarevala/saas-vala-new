...
const VALID_KEYS = ['FINTECH-APK-2026-001', 'FINTECH-APK-2026-002', 'FINTECH-APK-2026-003', 'FINTECH-PWA-2026-001', 'FINANCE-APK-2026-001'];
...
export default function FinancePwa() {
  ...
  const activate = () => {
    if (VALID_KEYS.includes(keyInput.trim().toUpperCase())) {
      ...
      toast.success(`🎉 License activated! Valid for ${LICENSE_DAYS} days. All 5 FinTech software demos unlocked.`);
