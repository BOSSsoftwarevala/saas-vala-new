...
const VALID_KEYS = ['ANALYTICS-APK-2026-001', 'ANALYTICS-APK-2026-002', 'ANALYTICS-APK-2026-003', 'ANALYTICS-PWA-2026-001', 'BI-APK-2026-001'];
...
export default function AnalyticsPwa() {
  ...
  const activate = () => {
    if (VALID_KEYS.includes(keyInput.trim().toUpperCase())) {
      ...
      toast.success(`🎉 License activated! Valid for ${LICENSE_DAYS} days. All 5 Analytics software demos unlocked.`);
