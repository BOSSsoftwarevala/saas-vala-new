...
const VALID_KEYS = ['PRODUCTIVITY-APK-2026-001', 'PRODUCTIVITY-APK-2026-002', 'PRODUCTIVITY-APK-2026-003', 'PRODUCTIVITY-PWA-2026-001', 'WORKSPACE-APK-2026-001'];
...
export default function ProductivityPwa() {
  ...
  const activate = () => {
    if (VALID_KEYS.includes(keyInput.trim().toUpperCase())) {
      ...
      toast.success(`🎉 License activated! Valid for ${LICENSE_DAYS} days. All 5 Productivity software demos unlocked.`);
